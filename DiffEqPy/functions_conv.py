...
from DiffEqPy.core import Function, as_variable
from DiffEqPy.utils import pair, get_conv_outsize, get_deconv_outsize
from DiffEqPy.functions import linear, broadcast_to
...
def im2col(x, kernel_size, stride=1, pad=0, to_matrix=True):
    ...
    Args:
        x (`DiffEqPy.Variable` or `ndarray`): Input variable of shape
            `(N, C, H, W)`
    ...
    Returns:
        `DiffEqPy.Variable`: Output variable. If the `to_matrix` is False, the
